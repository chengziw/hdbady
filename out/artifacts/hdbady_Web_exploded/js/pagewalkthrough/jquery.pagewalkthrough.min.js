(function ($, window, document, undefined) {
    ...
    function showStep(skipDirection) {
        ...
        $(step.wrapper).closest('.accordion-body').css('display', 'block');
        $(step.wrapper).closest('.accordion-body').siblings('.accordion-header').addClass('accordion-header-selected');
        $(step.wrapper).closest('.accordion-body').siblings('.accordion-header').find('.accordion-collapse').removeClass('accordion-expand');
