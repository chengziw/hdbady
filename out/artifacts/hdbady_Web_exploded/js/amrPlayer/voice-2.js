        ...
        */
        RongIMVoice.init = function () {
            if (this.isIE) {
                ...
                script.src = "/dear_assets/js/amrPlayer/swfobject-2.0.0.min.js";
                ...
                setTimeout(function () {
                    ...
                    swfobject.embedSWF("/dear_assets/swf/player-2.0.2.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 200);
            }
            else {
                var list = ["/dear_assets/js/amrPlayer/pcmdata-2.0.0.min.js", "/dear_assets/js/amrPlayer/libamr-2.0.1.min.js"];
