...
$(function () {
        $.ajax({
            type: 'post',
            url: 'studentVacationAction_t_pageQuery.action?flag='+flag+'',
            ...
            success: function (data) {
               ...
               var json = data.shijia;
                ...
                var json2 = data.yiyuebingjia;
                var json3 = data.yiyueshijia;
                ////////////////////////////////////////////////////////
                for(var i in json2){


                    var time ;
                    if(json2[i].starttime == json2[i].endtime){
                        time = json2[i].starttime +"号";

                    }else{
                        time = json2[i].starttime +"到"+json2[i].endtime+"";
                    }
                    //console.log(time);
                ...
                for(var i in json3){
                    ...
                    var time ;
                    if(json3[i].starttime == json3[i].endtime){
                        time = json3[i].starttime +"号";

                    }else{
                        time = json3[i].starttime +"到"+json3[i].endtime+"";
                    }
                    //console.log(time);
...
//    var array = new Array();
                ...
                $("ul.one li").on("click","button", function (event) {
                        ...
                        if(window.confirm('您要签阅该同学的请假信息吗？')) {
