...
<head>
    ...
    <link rel="stylesheet" href="parent/css/kaoqinjilu.css">
    <!--[if lt IE 9]>
    ...
    <script src="parent/js/kiner-swiper-panel.min.js" type="text/javascript"></script>
...
//        };
        ...
        function qingqiu(shijian){
            $.ajax({
                type: 'post',
                url: 'studentMonthCheckAction_p_pageQuery.action',
