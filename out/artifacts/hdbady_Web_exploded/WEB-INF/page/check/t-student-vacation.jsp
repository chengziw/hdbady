				...
				<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledBy="home-tab">
					...
					<div class="xuanze">
						<label class="radio-inline">
							<input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked="checked"> <span>病假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <span>事假</span>
						</label>

					</div>
					<div class="shurukuang">
						<textarea class="form-control" rows="5" placeholder="请假原因..."></textarea>
					</div>
