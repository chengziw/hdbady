...
<form id="ff" method="post" style="height:260px;" data-href="${pageContext.request.contextPath}/studentCheckAction_addStudentNote.action">
    <div class="easyui-layout" fit="true" border="true">

        <div region="north" border="true" style="overflow:auto; padding:8px;height:128px; ">
            <input type="hidden" name="id" value="<s:property value="studentCheck.id"/>">
            <table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td colspan="3"><s:property value="studentCheck.student.classes.class_name"/>(<s:property value="studentCheck.student.classes.grade.name"/>) ， <s:property value="studentCheck.student.name"/></td>
              </tr>
              <tr>
                  			    <td width="22%">考勤日期：</td>
                <td colspan="2"><s:property value="studentCheck.date_label"/></td>
              </tr>
              <tr>
                <td width="22%">考勤备注：</td>
                <td><input id="note" name="note" value="" class="easyui-textbox" required="true" data-options="novalidate:true," style="width:180px;"></td>
