            ...
            <table cellspacing="0" cellpadding="8" border="0">
                <tbody><tr>
                    <td>
                        <div>
                            <label>姓名：&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <input id="teacher_name" class="easyui-textbox textbox-f" value="" required="true" data-options="validType:'noNull'" style="display: none;" textboxname="teacher_name" type="text">
                            &nbsp;&nbsp;
                            <span id="sex"></span>
...
.datagrid-cell-c1-duty_name{width:71px}
                        ...
                        <div id="teacher_table_box" style="position: relative; width: 568px; height: 0px;z-index:1; display: none;" >
                            <table id="teacherTable" class="easyui-datagrid" style="height: 168px;width:520px; position: absolute;top: 0px; left: 0px;"
                                   data-options="url:'${pageContext.request.contextPath}/teacherAction_findAllTeacherToVacationAdd.action',
                                           onLoadSuccess:teacherDataLoadSuccess,onClickRow:teacherClickRow,
                                           rownumbers:true,singleSelect:true">
                                <thead>
                                <tr>
                ...
                <tr>
                    <td><label>请假类型：</label> <input id="type" class="easyui-validatebox validatebox-text combobox-f combo-f textbox-f" data-options="novalidate: true,validType:'vacationType',panelHeight:'auto'" value="" style="display: none;" textboxname="type" comboname="type" type="text">
					&nbsp;&nbsp;<br><label>请假开始：</label> <input id="start_time" value="" data-options="editable: false, width:100" class="datebox-f combo-f textbox-f" style="display: none;" textboxname="start_time" comboname="start_time" type="text">
					&nbsp;&nbsp;<br><label>请假结束：</label> <input id="end_time" value="" data-options="editable: false, width:100" class="datebox-f combo-f textbox-f" style="display: none;" textboxname="end_time" comboname="end_time" type="text">
                </tr> 
   
                <tr>
                    <td><label>请假原因：</label> <input id="reason" name="reason" class="easyui-textbox easyui-validatebox textbox-f validatebox-text" data-options="validType:'MaxLength',multiline:true, prompt:'', required:true, tipPosition: 'right', missingMessage: '请输入请假原因'" value="" style="width: 522px; height: 60px; display: none;" textboxname="reason">
                    </td>
                    <!-- heigth之前是25 -->
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var url =  "${pageContext.request.contextPath}/teacherVacationAction_addTeacherVacation.action"; // 保存地址
...
<div class="panel combo-p" style="position: absolute; z-index: 10; display: none;"><div class="combo-panel panel-body panel-body-noheader" title="" id="" style="overflow: hidden;"><div class="datebox-calendar-inner panel-noscroll"><div class="calendar calendar-noborder easyui-fluid" style="width: 0px; height: 178px;"><div class="calendar-header"><div class="calendar-nav calendar-prevmonth"></div><div class="calendar-nav calendar-nextmonth"></div><div class="calendar-nav calendar-prevyear"></div><div class="calendar-nav calendar-nextyear"></div><div class="calendar-title"><span class="calendar-text">4月 2017</span></div></div><div class="calendar-body" style="height: 156px;"><table class="calendar-dtable" cellspacing="0" cellpadding="0" border="0"><thead><tr><th>日</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th>六</th></tr></thead><tbody><tr class="calendar-first"><td class="calendar-day calendar-other-month calendar-sunday calendar-first " abbr="2017,3,26" style="">26</td><td class="calendar-day calendar-other-month " abbr="2017,3,27" style="">27</td><td class="calendar-day calendar-other-month " abbr="2017,3,28" style="">28</td><td class="calendar-day calendar-other-month " abbr="2017,3,29" style="">29</td><td class="calendar-day calendar-other-month " abbr="2017,3,30" style="">30</td><td class="calendar-day calendar-other-month " abbr="2017,3,31" style="">31</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,1" style="">1</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,2" style="">2</td><td class="calendar-day calendar-today calendar-selected " abbr="2017,4,3" style="">3</td><td class="calendar-day " abbr="2017,4,4" style="">4</td><td class="calendar-day " abbr="2017,4,5" style="">5</td><td class="calendar-day " abbr="2017,4,6" style="">6</td><td class="calendar-day " abbr="2017,4,7" style="">7</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,8" style="">8</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,9" style="">9</td><td class="calendar-day " abbr="2017,4,10" style="">10</td><td class="calendar-day " abbr="2017,4,11" style="">11</td><td class="calendar-day " abbr="2017,4,12" style="">12</td><td class="calendar-day " abbr="2017,4,13" style="">13</td><td class="calendar-day " abbr="2017,4,14" style="">14</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,15" style="">15</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,16" style="">16</td><td class="calendar-day " abbr="2017,4,17" style="">17</td><td class="calendar-day " abbr="2017,4,18" style="">18</td><td class="calendar-day " abbr="2017,4,19" style="">19</td><td class="calendar-day " abbr="2017,4,20" style="">20</td><td class="calendar-day " abbr="2017,4,21" style="">21</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,22" style="">22</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,23" style="">23</td><td class="calendar-day " abbr="2017,4,24" style="">24</td><td class="calendar-day " abbr="2017,4,25" style="">25</td><td class="calendar-day " abbr="2017,4,26" style="">26</td><td class="calendar-day " abbr="2017,4,27" style="">27</td><td class="calendar-day " abbr="2017,4,28" style="">28</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,29" style="">29</td></tr><tr class="calendar-last"><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,30" style="">30</td><td class="calendar-day calendar-other-month " abbr="2017,5,1" style="">1</td><td class="calendar-day calendar-other-month " abbr="2017,5,2" style="">2</td><td class="calendar-day calendar-other-month " abbr="2017,5,3" style="">3</td><td class="calendar-day calendar-other-month " abbr="2017,5,4" style="">4</td><td class="calendar-day calendar-other-month " abbr="2017,5,5" style="">5</td><td class="calendar-day calendar-other-month calendar-saturday calendar-last " abbr="2017,5,6" style="">6</td></tr></tbody></table><div class="calendar-menu" style="display: none;"><div class="calendar-menu-year-inner"><span class="calendar-nav calendar-menu-prev"></span><span><input class="calendar-menu-year" type="text"></span><span class="calendar-nav calendar-menu-next"></span></div><div class="calendar-menu-month-inner"></div></div></div></div></div></div></div><div class="panel combo-p" style="position: absolute; z-index: 10; display: none;"><div class="combo-panel panel-body panel-body-noheader" title="" id="" style="overflow: hidden;"><div class="datebox-calendar-inner panel-noscroll"><div class="calendar calendar-noborder easyui-fluid" style="width: 0px; height: 178px;"><div class="calendar-header"><div class="calendar-nav calendar-prevmonth"></div><div class="calendar-nav calendar-nextmonth"></div><div class="calendar-nav calendar-prevyear"></div><div class="calendar-nav calendar-nextyear"></div><div class="calendar-title"><span class="calendar-text">4月 2017</span></div></div><div class="calendar-body" style="height: 156px;"><table class="calendar-dtable" cellspacing="0" cellpadding="0" border="0"><thead><tr><th>日</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th>六</th></tr></thead><tbody><tr class="calendar-first"><td class="calendar-day calendar-other-month calendar-sunday calendar-first " abbr="2017,3,26" style="">26</td><td class="calendar-day calendar-other-month " abbr="2017,3,27" style="">27</td><td class="calendar-day calendar-other-month " abbr="2017,3,28" style="">28</td><td class="calendar-day calendar-other-month " abbr="2017,3,29" style="">29</td><td class="calendar-day calendar-other-month " abbr="2017,3,30" style="">30</td><td class="calendar-day calendar-other-month " abbr="2017,3,31" style="">31</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,1" style="">1</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,2" style="">2</td><td class="calendar-day calendar-today calendar-selected " abbr="2017,4,3" style="">3</td><td class="calendar-day " abbr="2017,4,4" style="">4</td><td class="calendar-day " abbr="2017,4,5" style="">5</td><td class="calendar-day " abbr="2017,4,6" style="">6</td><td class="calendar-day " abbr="2017,4,7" style="">7</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,8" style="">8</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,9" style="">9</td><td class="calendar-day " abbr="2017,4,10" style="">10</td><td class="calendar-day " abbr="2017,4,11" style="">11</td><td class="calendar-day " abbr="2017,4,12" style="">12</td><td class="calendar-day " abbr="2017,4,13" style="">13</td><td class="calendar-day " abbr="2017,4,14" style="">14</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,15" style="">15</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,16" style="">16</td><td class="calendar-day " abbr="2017,4,17" style="">17</td><td class="calendar-day " abbr="2017,4,18" style="">18</td><td class="calendar-day " abbr="2017,4,19" style="">19</td><td class="calendar-day " abbr="2017,4,20" style="">20</td><td class="calendar-day " abbr="2017,4,21" style="">21</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,22" style="">22</td></tr><tr class=""><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,23" style="">23</td><td class="calendar-day " abbr="2017,4,24" style="">24</td><td class="calendar-day " abbr="2017,4,25" style="">25</td><td class="calendar-day " abbr="2017,4,26" style="">26</td><td class="calendar-day " abbr="2017,4,27" style="">27</td><td class="calendar-day " abbr="2017,4,28" style="">28</td><td class="calendar-day calendar-saturday calendar-last " abbr="2017,4,29" style="">29</td></tr><tr class="calendar-last"><td class="calendar-day calendar-sunday calendar-first " abbr="2017,4,30" style="">30</td><td class="calendar-day calendar-other-month " abbr="2017,5,1" style="">1</td><td class="calendar-day calendar-other-month " abbr="2017,5,2" style="">2</td><td class="calendar-day calendar-other-month " abbr="2017,5,3" style="">3</td><td class="calendar-day calendar-other-month " abbr="2017,5,4" style="">4</td><td class="calendar-day calendar-other-month " abbr="2017,5,5" style="">5</td><td class="calendar-day calendar-other-month calendar-saturday calendar-last " abbr="2017,5,6" style="">6</td></tr></tbody></table><div class="calendar-menu" style="display: none;"><div class="calendar-menu-year-inner"><span class="calendar-nav calendar-menu-prev"></span><span><input class="calendar-menu-year" type="text"></span><span class="calendar-nav calendar-menu-next"></span></div><div class="calendar-menu-month-inner"></div></div></div></div></div></div></div><div class="panel combo-p" style="position: absolute; z-index: 10; display: none;"><div class="combo-panel panel-body panel-body-noheader" title=""><div id="_easyui_combobox_i1_0" class="combobox-item combobox-item-selected">请选择请假类型</div><div id="_easyui_combobox_i1_1" class="combobox-item">病假</div><div id="_easyui_combobox_i1_2" class="combobox-item">事假</div><div id="_easyui_combobox_i1_3" class="combobox-item">婚假</div><div id="_easyui_combobox_i1_4" class="combobox-item">丧假</div><div id="_easyui_combobox_i1_5" class="combobox-item">产假</div><div id="_easyui_combobox_i1_6" class="combobox-item">其他假</div></div></div></body></html>