...
<div class="neirong" id="youeryuan">
    ...
    <div class="toubu">
        ...
        <div style="float: left;font-size: 20px;color: white;line-height:80px ">设置家长关系</div>
        <div style="float: right;margin-right: 15px;margin-top: 24px"><input type="button" style="font-size: 22px" value="保存"/></div>
    </div>
    <div class="guanxi">
        <div style="font-size: 15px;line-height: 60px;margin-left: 10px;float: left">我是唐杨杨的</div>
        <div style="float: left;line-height: 60px;margin-left: 20px;font-size: 15px">叔叔</div>
        <div class="box1" style="float: right;margin-right: 20px;margin-top: 25px"></div>
    </div>
