        ...
        <div class="panel layout-panel layout-panel-north" style="width: 1026px; left: 0px; top  : 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 1008px; height: 482px;" title="" class="panel-body panel-body-noheader layout-body">
            ...
            <table width="100%" cellspacing="0" cellpadding="8" border="0">
                <tbody><tr>
                    ...
                    <td><input id="student_no" name="student_no" class="easyui-textbox textbox-f" style="display: none;" data-options="validType:['MaxLength']" textboxname="student_no"></td>
                    <td align="right">年级：</td>
                    <td><input id="grade_id" name="grade_id" value="" data-options="validType:'noNull',panelHeight:'auto'" style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="grade_id" disabled="disabled" comboname="grade_id"></td>
                    <td align="right">就读班级：</td>
                    <td><input id="class_id" name="class_id" value="" data-options="panelHeight:'auto'" style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="class_id" disabled="disabled" comboname="class_id"></td>
                ...
                <tr>
                    ...
                    <td>
                        <input id="name" name="name" value="" class="easyui-textbox textbox-f" required="true" data-options="validType:['name','MaxLength']" style="display: none;" textboxname="name"></span>
                    </td>
                    ...
                    <td><input id="sex" name="sex" required="true" data-options="validType:['noNull','MaxLength'],panelHeight:'auto'" style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="sex" comboname="sex"></td>
                    <td align="right">出生日期：</td>
                    <td><input id="yearMonthDay" name="yearMonthDay" required="true" data-options="" style="cursor: pointer; display: none;" class="datebox-f combo-f textbox-f" textboxname="yearMonthDay" comboname="yearMonthDay"></td>
                </tr>
                <tr>
                    <td align="right">本地生源：</td>
                    <td><input id="is_local" name="is_local" data-options="panelHeight:'auto',validType:'noNull'," style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="is_local" comboname="is_local"></td>
                    <td align="right">教职子弟：</td>
                    <td><input id="is_teacherson" name="is_teacherson" data-options="panelHeight:'auto',validType:'noNull'," style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="is_teacherson" comboname="is_teacherson"></td>
                    <td align="right">户口类型：</td>
                    <td><input id="census_type" name="census_type" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="census_type" comboname="census_type"></td>
                    <td align="right">预期报道时间：</td>
                    <td><input id="attend_shool_time_name" name="attend_shool_time_name" required="true" data-options="" style="cursor: pointer; display: none;" class="combo-f textbox-f datetimebox-f" textboxname="attend_shool_time_name" comboname="attend_shool_time_name"></td>
                </tr>

                <tr>
                    <td align="right">家长姓名：</td>
                    <td><input id="parent_name" name="parent_name" value="" class="easyui-textbox textbox-f" required="true" data-options="validType:['name','MaxLength']" style="cursor: pointer; display: none;" textboxname="parent_name"></td>
                    <td align="right">关系：</td>
                    <td><input id="relationship" name="relationship" value="" data-options="validType:'noNull',panelHeight:'auto'" style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="relationship" comboname="relationship"></td>
                    <td align="right">手机号：</td>
                    <td><input id="phone" name="phone" value="" class="easyui-textbox textbox-f" required="true" data-options="validType:'mobile'" style="cursor: pointer; display: none;" textboxname="phone"></td>
                    <td align="right">家庭住址：</td>
                    <td colspan="3"><input id="address" name="address" value="" class="easyui-textbox textbox-f" required="true" data-options="validType:'MaxLength'" style="display: none;" textboxname="address"></td>
                </tr>

                <tr>
                    <td align="right">兴趣爱好：</td>
                    <td colspan="5">
                        <label><input style="width:15px;" name="interests" class="interests" value="0" type="checkbox"> 唱歌&nbsp;&nbsp;</label><label><input style="width:15px;" name="interests" class="interests" value="1" type="checkbox"> 跳舞&nbsp;&nbsp;</label><label><input style="width:15px;" name="interests" class="interests" value="2" type="checkbox"> 下棋&nbsp;&nbsp;</label><label><input style="width:15px;" name="interests" class="interests" value="3" type="checkbox"> 体育运动&nbsp;&nbsp;</label><label><input style="width:15px;" name="interests" class="interests" value="4" type="checkbox"> 游戏&nbsp;&nbsp;</label><label><input style="width:15px;" name="interests" class="interests" value="5" type="checkbox"> 其他&nbsp;&nbsp;</label>                    </td>
                </tr>

                <tr>
                    <td align="right">身体状况：</td>
                    <td><input id="health_status" name="health_status" value="" required="true" class="easyui-combobox combobox-f combo-f textbox-f" data-options="validType:'noNull',panelHeight:'auto'" style="cursor: pointer; display: none;" textboxname="health_status" comboname="health_status"></td>
                    <td align="right">有无过敏史：</td>
                    <td><input id="is_allergy" name="is_allergy" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_allergy" comboname="is_allergy"></td>
                    <td align="right">有无先天病：</td>
                    <td><input id="is_predisease" name="is_predisease" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_predisease" comboname="is_predisease"></td>
                    <td align="right">有无体检表：</td>
                    <td><input id="is_health_form" name="is_health_form" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_health_form" comboname="is_health_form"></td>
                </tr>

                <tr>
                    <td align="right">有无验证证明：</td>
                    <td><input id="is_health_verify" name="is_health_verify" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_health_verify" comboname="is_health_verify"></td>
                    <td align="right">有否接种复印件：</td>
                    <td><input id="is_ccine" name="is_ccine" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_ccine" comboname="is_ccine"></td>
                    <td align="right">血型：</td>
                    <td><input id="blood_type" name="blood_type" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="blood_type" comboname="blood_type"></td>
                    <td align="right">易患何种病：</td>
                    <td><input id="commom_disease" name="commom_disease" data-options="validType:'MaxLength'" class="easyui-textbox textbox-f" style="display: none;" textboxname="commom_disease"></td>
                </tr>


                <tr>
                    <td align="right">就读方式：</td>
                    <td><input id="timetype_id" name="timetype_id" style="cursor: pointer; display: none;" class="combobox-f combo-f textbox-f" textboxname="timetype_id" comboname="timetype_id"></td>
                    <td align="right">独生子女：</td>
                    <td><input id="is_only_child" name="is_only_child" class="combobox-f combo-f textbox-f" style="display: none;" textboxname="is_only_child" comboname="is_only_child"></td>
                    <td align="right">出生地：</td>
                    <td><input id="birthplace" name="birthplace" data-options="validType:'MaxLength'" class="easyui-textbox textbox-f" style="display: none;" textboxname="birthplace"></td>
                    <td align="right">身份证：</td>
                    <td><input id="identity_card" name="identity_card" class="easyui-textbox textbox-f" style="display: none;"data-options="validType:'idcard'"  textboxname="identity_card"></td>
                </tr>
                <tr>
                    <td align="right">学生要求：</td>
                    <td colspan="5"><input id="demand" name="demand" value="" class="easyui-textbox textbox-f" data-options="validType:'MaxLength'" style="width: 654px; display: none;" textboxname="demand"></td>
                </tr>
                <tr>
                    <td align="right">学校备注：</td>
                    <td colspan="5"><input id="note" name="note" class="easyui-textbox textbox-f" data-options="validType:'MaxLength'" style="width: 654px; display: none;" textboxname="note"></td>
                </tr>
                <tr>
                    <!-- <td align="right">预约时间：</td>
                    <td><input id="create_time_name" name="create_time_name" value="" readonly="true" style："border:none" class="easyui-textbox textbox-f" style="display: none;" textboxname="create_time_name"></td>
                    ...
                    <td>待到校报名</td>
                    <input id="status_name" name="status_name" value="2" readonly="true" type="hidden" style："border:none"/></td>             
...
/* 转换PHPJSON为JS JSON格式 */
    ...
    function saveFrom(){
        ...
        $('#ff').form('submit',{
        	url:'${pageContext.request.contextPath}/studentBespeakAction_addBespeakStudent.action',
            onSubmit:function(){
       ...
       /*  //是否本校
        ...
        $("#yearMonthDay").datebox({ 
       	 onSelect : function(beginDate){ 
       	  $('#attend_shool_time_name').datebox().datebox('calendar').calendar({ 
