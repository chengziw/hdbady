...
<head>
	...
	<link rel="stylesheet" href="teacher/css/xueshengxiangce_fabu.css">
	<!--[if lt IE 9]>
...
<div class="neirong" id="youeryuan">
	<header id="ha">
		<a href="studentAction_t_studentPhoto.action">
	...
	<section>
			...
			<div id="body" class="light">
				<div id="content" class="show">
					...
					<div class="demo">
						...
						<form id="uploadForm" action="studentAction_t_importPicture.action" method="post" enctype="multipart/form-data">
                            ...
                            <div class="xueke">
								...
								<input type="text" class="hidden" id="s_id" name="id" value="隐藏的学生id"/>
		...
		<script src="teacher/js/xueshengxiangce_fubu.js"></script>
