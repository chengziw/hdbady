...
<form id="ff" method="post" style="height:348px;" data-href="/teacher/save-holiday-teacher.html?id=16&amp;sinKey=8516%25EB%253F%25ACf%2524%25B4S%25E8%25CBN%251E%2524%255E%25D9%25FE%25E1%2581%25FD%25F8%250Eb%25E2%25233%257D%25AB%25E6I%25EC%25EB%251F%2583%25D5%2598%253D%2504%25D6%2583k%2502T%250A%25C2%2503" class="panel-noscroll">
        ...
        <div class="panel layout-panel layout-panel-north" style="width: 776px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 758px; height: 260px;" title="" class="panel-body panel-body-noheader layout-body">
            ...
            <table width="100%" cellspacing="0" cellpadding="8" border="0">
                <tbody><tr>
                    ...
                    <td width="100">性别：</td>
                    <td width="50"><s:property value="teacher.sex_name"/></td>
                    <td width="80">出生日期：</td>
                    <td width="100"><s:property value="teacher.brither_name"/></td>
                    <td width="80">工号：</td>
                    <td width="100"><s:property value="teacher.worknumber"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>休假备注：</td>
                    <td colspan="5"><input id="note" name="note" class="easyui-textbox textbox-f" style="width: 330px; display: none;" data-options="" textboxname="note"></td>
                </tr>
...
<script type="text/javascript">
    function saveFrom(){
        ...
        $('#ff').form('submit',{
        	url:'${pageContext.request.contextPath}/teacherAction_vacationTeacher.action',
