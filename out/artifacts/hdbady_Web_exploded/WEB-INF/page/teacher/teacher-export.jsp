...
<form id="ff" method="post" style="height:368px;" enctype="multipart/form-data" data-href="/teacher/out-excel-teacher.html" class="panel-noscroll">
    <div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 556px; height: 368px;">

        <div class="panel layout-panel layout-panel-north" style="width: 556px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 538px; height: 280px;" title="" class="panel-body panel-body-noheader layout-body">
...
&nbsp;至&nbsp;
        ...
        <div class="panel layout-panel layout-panel-center" style="width: 556px; left: 0px; top: 297px;"><div region="center" border="false" style="overflow: hidden; background-color: rgb(224, 236, 255); width: 556px; height: 71px;" title="" class="panel-body panel-body-noheader panel-body-noborder layout-body">
