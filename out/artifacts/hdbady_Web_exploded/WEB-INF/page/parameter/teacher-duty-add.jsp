...
<form id="ff" method="post" style="height:138px;" data-href="${pageContext.request.contextPath}/teacherDutyAction_addTeacherDuty.action" class="panel-noscroll">
    <div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 496px; height: 138px;">
        ...
        <div class="panel layout-panel layout-panel-north" style="width: 496px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 478px; height: 50px;" title="" class="panel-body panel-body-noheader layout-body">
            ...
            <table width="100%" cellspacing="0" cellpadding="8" border="0">
              ...
              <tbody><tr>
                <td width="20%" >职务名称：</td>
                <td><input id="duty_name" name="duty_name" value="" class="easyui-textbox textbox-f" required="true" data-options="prompt:'如：园长/教务主任等',validType:'MaxLength'" style="width: 200px; display: none;" textboxname="duty_name"><%-- <span class="textbox" style="width: 198px; height: 20px;"><input class="textbox-text validatebox-text textbox-prompt" autocomplete="off" placeholder="如：园长/教务主任等" style="margin-left: 0px; margin-right: 0px; padding-top: 2px; padding-bottom: 2px; width: 190px;" type="text"><input class="textbox-value" name="duty_name" value="" type="hidden"></span> --%>
                </td>
