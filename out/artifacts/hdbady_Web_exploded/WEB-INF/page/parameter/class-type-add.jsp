...
<form id="ff" method="post" style="height:138px;" data-href="${pageContext.request.contextPath}/classTypeAction_addClassType.action" class="panel-noscroll">
