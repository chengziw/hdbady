...
<head>
	...
	<link rel="stylesheet" href="teacher/css/meirishipu_fabu.css">
	<!--[if lt IE 9]>
...
<div class="neirong" id="youeryuan">
	<header id="ha">
		<a href="${pageContext.request.contextPath}/cookBookAction_t_cookBook.action">
			<span class="glyphicon glyphicon-menu-left">发布食谱</span>
		</a>
	...
	<section>
			...
			<div id="body" class="light">
				<div id="content" class="show">
					...
					<div class="demo">
						...
						<form id="uploadForm" action="cookBookAction_t_addCookBook.action" method="post" enctype="multipart/form-data">
		...
		<script src="teacher/js/meirishipu_fubu.js"></script>
