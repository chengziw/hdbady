...
$("#buttontijiao").click(function () {
	...
	var type= $("input[name='typee']:checked").val()  
	var reason=$("#reason").val();
	var  url="studentVacationAction_p_addStudentVacation.action";
		$('#form').form('submit',{
	        url: url,
...
$(function () {
        $.ajax({
            type: 'post',
            url: 'studentVacationAction_p_pageQuery.action?page='+yema+'&rows=3',
