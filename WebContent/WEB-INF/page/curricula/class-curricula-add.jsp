...
<form id="post-form" style="height:643px; " method="post" data-href="${pageContext.request.contextPath}/curriculaTableAction_addCurriculaTable.action" class="panel-noscroll">
                ...
                <div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 236px; height: 604px;">                
                    <table cellspacing="0" cellpadding="8" border="0">
                       ...
                       <tr>
                            <td>年级：</td>
                            <td>
                            <!--<span id="grade_box">中间是下面的input标签<span class="textbox textbox-invalid combo" style="width: 148px; height: 20px;">-->
                                <input id="grade_name" name="" value="" required="true" data-options="validType:['validateGradeId','noNull'],panelHeight:'auto'" style="width: 150px; display: none;" class="combobox-f combo-f textbox-f" textboxname="grade_name" comboname="grade_name"><%-- <span class="textbox-addon textbox-addon-right" style="right: 0px;"><a href="javascript:void(0)" class="textbox-icon combo-arrow" icon-index="0" tabindex="-1" style="width: 18px; height: 20px;"></a></span><input class="textbox-text validatebox-text validatebox-invalid" autocomplete="off" readonly="readonly" placeholder="" style="margin-left: 0px; margin-right: 18px; padding-top: 2px; padding-bottom: 2px; width: 122px;" type="text"><input class="textbox-value" name="grade_name" value="" type="hidden"></span></span> --%>
                                <%-- <span id="grade_show_error_message" style="color: red;"></span> --%>
                            </td>
                        </tr>
                        <tr id="class_box">
                            <td>班级：</td>
                            <td>
                                <input id="class_name" name="classes.id" value="" required="true" data-options="validType:['validateClassId','noNull'],panelHeight:'auto'" style="width: 150px; display: none;" class="combobox-f combo-f textbox-f" textboxname="class_name" comboname="class_name"><%-- <span class="textbox textbox-invalid combo" style="width: 148px; height: 20px;"><span class="textbox-addon textbox-addon-right" style="right: 0px;"><a href="javascript:void(0)" class="textbox-icon combo-arrow" icon-index="0" tabindex="-1" style="width: 18px; height: 20px;"></a></span><input class="textbox-text validatebox-text validatebox-invalid" autocomplete="off" readonly="readonly" placeholder="" style="margin-left: 0px; margin-right: 18px; padding-top: 2px; padding-bottom: 2px; width: 122px;" type="text"><input class="textbox-value" name="class_name" value="" type="hidden"></span> --%>
                            </td>
                        </tr>
                    ...
                    <table id="class-curricula-table" cellspacing="1">
                        <tbody>
                             ...
                             <s:iterator begin="1" end="#morning_has_num+#afternoon_has_num" status="vs">
                            	...
                            	<tr>
                            		<td id="time" class="time"><s:property value="#start_end_times[#vs.index]"/></td>
                          	 	  	 	<s:iterator begin="1" end="#dayNum" status="v">
                          	 	  	 		 <td class="drop">
			                          	  	 	    <span class="subject-drop">
			                                            <input id="subjectinput" class="subject-input combobox-f combo-f textbox-f" value="" data-options="novalidate:true" style="display: none;" textboxname="subject_names" comboname="subject_names" type="text">
			                                        </span>
			                                        <span class="teacher-drop">
                                        			    <input id="<s:property value="#teacherinputs[#vs.index][#v.index]"/>" value="" validtype="checkDatas" class="teacher-input combobox-f combo-f textbox-f" data-teacherids="" data-options="novalidate:true" style="display: none;" textboxname="teacher_ids" comboname="teacher_ids" type="text">
                                      				</span>
            		 								<input id="teacher_names" name="teacher_names" value="" type="hidden"/>
                                      				<input name="weeks" type="hidden" value="<s:property value="#v.index+1"/>">
              		 								<input name="courses" type="hidden" value="<s:property value="#vs.index+1"/>">
		                                       </td>
   									  	 </s:iterator>
   								</tr>
                           	 </s:iterator>
...
$.extend($.fn.validatebox.defaults.rules, {
	validateGradeId: {
        validator: function(value){
            return (value == '请选择年级'? false: true);
        },
        message: '请选择年级'
    },
    validateClassId: {
        validator: function(value){
            return (value == '请选择班级'? false: true);
        },
        message: '请选择班级'
    },
    noNull: {
...
function saveClassCurricula() {
    ...
    var url='${pageContext.request.contextPath}/curriculaTableAction_addCurriculaTable.action';
     ...
     //年级
        $('#grade_name').combobox({
            ...
            onLoadSuccess:function(){
                $('#grade_name').combobox("setValue","请选择");
            },
            onSelect:function(record){
            	$('#class_name').combobox({data:record.classList,value:'',disabled:false});
            	var id = record.id;
            	var url='${pageContext.request.contextPath}/classesAction_findAllClassByGradeId.action?id='+id+'';
            	$('#class_name').combobox('reload', url);
            }
        });
        ...
        $('#class_name').combobox({
            ...
            editable:false,
            onLoadSuccess:function(){
                $('#class_name').combobox("setValue","请选择");
            }
        });
    ...
    $.each( $('.teacher-input'), function(k, v){
        ...
        $(tempId).combobox({
            ...
            onSelect:function(record){
                ...
                //alert(record.id);
				//$("#teacher-drop").append("<input id='teacher_id' name='teacher_id' value='' />");
            }
