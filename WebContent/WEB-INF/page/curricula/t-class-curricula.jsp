...
<head>
  ...
  <link rel="stylesheet" href="teacher/css/main1.css">
  <link rel="stylesheet" href="teacher/css/javascript.fullPage.css">
  <script src="teacher/js/jquery.js" type="text/javascript"></script>
  <script src="teacher/js/main.js" type="text/javascript"></script>
  <script src="teacher/js/jquery.fullPage.js" type="text/javascript"></script>
...
<body>
<div class="header"><a href="teacherAction_t_home.action" class="pull-left"><img class="dayuhao" src="images/left.png" alt=""></a><span class="pull-left">课程安排</span></div>
