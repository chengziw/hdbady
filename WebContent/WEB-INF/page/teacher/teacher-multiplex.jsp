...
<form id="ff" method="post" style="height:348px;" data-href="/teacher/save-return-teacher.html?id=12&amp;sinKey=c07a%257F%2508%258C9%25CF%25F6%2580%25DD%252F%25B8%25183G%258DR%2586%2528sB%250D-P%257C%25B3%2519%25A6%25A8%25A2%25C2%25800%25CEU%250E%2525%25B1%2582%2527%2504%25268%25A7%25F4" class="panel-noscroll">
    <div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 776px; height: 348px;">
        ...
        <div class="panel layout-panel layout-panel-center" style="width: 776px; left: 0px; top: 277px;"><div region="center" border="false" style="overflow: hidden; background-color: rgb(224, 236, 255); width: 776px; height: 71px;" title="" class="panel-body panel-body-noheader panel-body-noborder layout-body">
            <div id="dlg-buttons" style="background-color:#E0ECFF; padding-top:8px; padding-bottom:0px; float:right;">
                ...
                <a href="#" id="save-btn" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-save" onclick="saveFrom()" group="">复工</a>
...
<script type="text/javascript">
    function saveFrom(){
        ...
        $('#ff').form('submit',{
        	url:'${pageContext.request.contextPath}/teacherAction_multiplexTeacher.action',
