    ...
    <div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 1349px; height: 668px;">
        ...
        <div class="panel layout-panel layout-panel-north" style="width: 1349px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 1331px; height: 580px;" title="" class="panel-body panel-body-noheader layout-body">
            <div style="padding: 0 0 15px 0;">
                ...
                <a id="mysearch_btn" href="#" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" plain="true" data-options="iconCls:'icon-search'" style="margin-left:8px;" onclick="callback();return false;" group="">保存</a>
            </div>
...
.datagrid-cell-c2-sex_name{width:61px}
.datagrid-cell-c2-yearMonthDay{width:96px}
.datagrid-cell-c2-is_local_name{width:96px}
.datagrid-cell-c2-is_teacherson_name{width:96px}
.datagrid-cell-c2-grade_name{width:96px}
.datagrid-cell-c2-class_name{width:149px}
...
.datagrid-cell-c2-status_name{width:138px}
            ...
            <div style="padding: 15px 0 0 0;">
                将选中的学生分入以下班级：
                <input id="allot_grade_id" required="true" data-options="panelHeight:'auto',validType:'noNull'" style="width: 160px; display: none;" class="combobox-f combo-f textbox-f" textboxname="grade_id" comboname="grade_id">
                    
                <input id="allot_class_id" name="classes.id" required="true" data-options="panelHeight:'auto',validType:'noNull'" style="width: 160px; display: none;" class="combobox-f combo-f textbox-f" textboxname="class_id" comboname="class_id">
...
<script type="text/javascript">
    ...
    function saveFrom(){
        ...
        $('#ff').form('submit',{
        	url:'${pageContext.request.contextPath}/studentAction_batchAllotStudent.action',
    ...
    $(function(){
        ...
        $('#allot_grade_id').combobox({
            ...
            editable:false,
            onLoadSuccess:function(){
                $('#allot_grade_id').combobox("setValue","请选择");
            },
            onSelect:function(record){
            	$('#allot_class_id').combobox({data:record.classList,value:'',disabled:false});
            	var grade = record.name;
            	var url='${pageContext.request.contextPath}/classesAction_findAllClassByGradeToSelect.action?grade='+grade+'';
            	$('#allot_class_id').combobox('reload', url);
                
            }
        })

        $('#allot_class_id').combobox({
            data: [{id: '', name: '全部班级'}],
            valueField:'id',
            textField:'name',
            editable:false,
            onLoadSuccess:function(){
                $('#allot_class_id').combobox("setValue","请选择");
            }
        }) */
