...
<div class="neirong" id="youeryuan">
    <div class="toubu">
        ...
        <div style="float: left;font-size: 20px;color: white;line-height:80px ">关于我们</div>
    </div>
    <div>
        <p>关于“汤圆宝贝”？</p>
        <div>汤圆宝贝是专门为汤圆幼儿园研发设计的综合管理云应用软件，旨在利用先进的移动互联网和云计算，让幼儿园的管理和运营变得高效、科学和规范。软件拥有收费管理、作业管理、食谱管理等多项实用功能，支持无线分园管理，是开办幼儿园的必备好帮手！</div>
    </div>
</div>
