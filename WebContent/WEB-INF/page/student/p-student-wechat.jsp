...
<div class="neirong" id="youeryuan">
    ...
    <div class="toubu">
        ...
        <div style="float: left;font-size: 20px;color: white;line-height:80px">设置微信</div>
    ...
    <div class="guanxi">
        <div style="line-height: 60px;font-size: 20px;margin-left: 10px">微信&nbsp;&nbsp;<input name="weixin" type="text" style="font-size: 20px;height: 40px" value="2550378943"></div>
   		<input type="type" value="weixin" type="hidden"/>
    </div>
	</form>
