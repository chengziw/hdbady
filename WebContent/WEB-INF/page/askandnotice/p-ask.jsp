...
<head>
    ...
    <link rel="stylesheet" href="parent/css/wenjuandiaocha.css">
    <!--[if lt IE 9]>
    ...
    <!--<script src="js/huadongli.js"></script>-->
    <style>
...
<div class="neirong" id="youeryuan">
    ...
    <section>
        ...
        <div class="content hidden">
            ...
            <form action="${pageContext.request.contextPath}/askAction_p_checkAsk.action" method="post">
                 <div class="tijiao ">
                <div class="xuanxiang">
...
<script src="parent/js/wenjuandiaocha.js"></script>
