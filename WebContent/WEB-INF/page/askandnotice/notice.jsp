...
<div class="easyui-layout" fit="true">
	...
	<div region="north" border="false" style="padding:10px;height:48px; padding-top:16px; padding-bottom:0px; overflow:hidden;">	
        ...
        <div class="easyui-layout" fit="true" border="false">
            ...
            <div id="main_body_tool" region="west" style="width:108px; padding-right:18px;" border="false">
                    ...
                    <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="add()">起草新通知</a>
            ...
            <div id="main_body_search" region="center" border="false" style="padding-left:0px;">筛选：
                <input id="notice_type" value="" style="cursor:pointer; width: 110px;"  class="easyui-combobox" data-options="panelHeight:'auto', novalidate:true">
	...
	<div region="center" border="false" id="main_body_datagrid" style="padding:8px; padding-bottom:0px;">
		...
		<table id="tt" class="easyui-datagrid"
			   data-options="url:'${pageContext.request.contextPath}/noticeAction_pageQuery.action',fitColumns:true,fit:true,pagination:true,
			...
			<thead>
			<tr>
				<th data-options="field:'title',width:140">通知标题</th>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        /* 通知级别 */
        var noticeTypeData = [
            {id:0,name:"全部通知级别",selected:true},{id:1,name:"集团级通知"},{id:2,name:"学校级通知"}        ];
  ...
  /*   function add(){
        var url = '/notice/add.html';
        var title = '起草新通知公告';
        var callfun = 'callback';
        openTopWindow(url,title,780,388,callfun);
    }
    ...
    function more(index){
        ...
        var title = '通知公告详情';
        var callfun = 'callback';
        openTopWindow(url,title,780,598,callfun);
    } */
    
    function add(){
        var url = '${pageContext.request.contextPath}/page_askandnotice_notice-add.action';
        var title = '起草新通知公告';
        var callfun = 'callback';
        openTopWindow(url,title,780,388,callfun);
    }
    ...
    function edit(index){
        ...
        var row = $('#tt').datagrid('getSelected');
        var id =row.id;
        var url = '${pageContext.request.contextPath}/noticeAction_edit.action?id='+id+'';
        var title = '编辑通知公告';
        var callfun = 'callback';
        openTopWindow(url,title,780,388,callfun);
    }
    ...
    function del(index){
        ...
        var row = $('#tt').datagrid('getSelected');
        var id =row.id;
        var url = '${pageContext.request.contextPath}/noticeAction_delete.action?id='+id+'';
        var title = '删除通知公告';
        var callfun = 'callback';
        openTopWindow(url,title,298,130,callfun);
    }
    ...
    function more(index){
        ...
        var row = $('#tt').datagrid('getSelected');
        var id =row.id;
        var url = '${pageContext.request.contextPath}/noticeAction_about.action?id='+id+'';
        var title = '通知公告详情';
        var callfun = 'callback';
        openTopWindow(url,title,780,598,callfun);
    }
    ...
    function putOut(index){
        ...
        var row = $('#tt').datagrid('getSelected');
        var id =row.id;
        var url = '${pageContext.request.contextPath}/noticeAction_putOut.action?id='+id+'';
        var title = '发布通知公告';
        var callfun = 'callback';
        openTopWindow(url,title,298,130,callfun);
    }
    ...
    function callback(){
        $('#tt').datagrid('reload',{
            notice_type: $('#notice_type').combobox("getValue"),
