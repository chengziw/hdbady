...
<div class="easyui-layout layout easyui-fluid" fit="true" border="true" style="width: 1041px; height: 695px;">
    ...
    <div class="panel layout-panel layout-panel-north" style="width: 1041px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 1023px; height: 640px;" title="" class="panel-body panel-body-noheader layout-body">
        <div>
            <div>
                <!-- 考勤年月日
                <div><span>2017年</span><span>3月</span></div> -->
                <!-- 考勤学生汇总信息 -->
                <div style="padding-top:0px;">
				
					<table cellspacing="0" cellpadding="0" bgcolor="#D8D8D8" border="0" width="1020">
					  <tbody><tr bgcolor="#FFFFFF">
						...
						<td align="left" width="100">刘亚真 ， 女<!-- ， 13600109677--></td>
                ...
                <div style="margin-top:8px; margin-bottom:12px;">
					...
					<table cellspacing="1" cellpadding="6" bgcolor="#D8D8D8" border="0" width="1023">
					  <tbody><tr bgcolor="#FFFFFF">
						...
						<td bgcolor="#f0f0f0" align="right" width="70">当月应出勤</td>
						<td align="left" width="40">22 天</td>	
											
						<td bgcolor="#f0f0f0" align="right" width="60">实际出勤</td>
						<td align="left" width="40">0 天</td>					

						<td bgcolor="#f0f0f0" align="right" width="30">正常</td>
						<td align="left" width="40">0 天</td>	
						
						<td bgcolor="#f0f0f0" align="right" width="30">迟到</td>
						<td align="left" width="40">0 天</td>	
						
						<td bgcolor="#f0f0f0" align="right" width="30">早退</td>
						<td align="left" width="40">0 天</td>	
                ...
                <div id="clockTeacherBox">
                    ...
                    <div class="clockTeacherBoxInfo"><div class="clockTeacherBoxInfo_base preBgColor"><p class="preText">2月27</p><p></p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="preText">2月28</p><p></p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">1 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">2 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">3 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">4 </span>休息日</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">5 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">6 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">7 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">8 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">9 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">10 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">11 </span>休息日</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">12 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">13 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">14 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">15 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">16 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">17 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">18 </span>休息日</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">19 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">20 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">21 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">22 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">23 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">24 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">25 </span>休息日</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">26 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">27 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">28 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="currentText"><span class="currentTextDay">29 </span>休息日</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">30 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base "><p class="currentText"><span class="currentTextDay">31 </span>缺卡</p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="preText">4月1</p><p></p></div><div class="clockTeacherBoxInfo_base preBgColor"><p class="preText">4月2</p><p></p></div><div class="clear"></div></div>
                </div>
    ...
    <div class="panel layout-panel layout-panel-center" style="width: 1041px; left: 0px; top: 657px;"><div region="center" border="false" style="overflow: hidden; background-color: rgb(224, 236, 255); width: 1041px; height: 38px;" title="" class="panel-body panel-body-noheader panel-body-noborder layout-body">
        <div id="dlg-buttons" style="background-color:#E0ECFF; padding-top:8px; padding-bottom:0px; float:right;">
            <a href="#" class="easyui-linkbutton panel-tool-close l-btn l-btn-small" iconcls="icon-no" onclick="javascript:parent.$('#openWindow').window('close');" group="" id=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">关闭</span><span class="l-btn-icon icon-no">&nbsp;</span></span></a>
        </div>
    </div></div>
...
function ajaxGetJsonData(){
    ...
    var teacher_id = '2';
    var url = '${pageContext.request.contextPath}/json/teacher-month-check.json';
    $.ajax({
        url: url,
        /* data: {year:year, month:month, teacher_id:teacher_id, action:'json'}, */
        data: {},
        type: 'GET',
        dataType: 'JSON',
