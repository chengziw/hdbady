        ...
        <div class="panel layout-panel layout-panel-north" style="width: 288px; left: 0px; top: 0px;"><div region="north" border="true" style="overflow: auto; padding: 8px; width: 270px; height: 210px;" title="" class="panel-body panel-body-noheader layout-body">
            <table cellspacing="0" cellpadding="8" border="0">
                ...
                <tr style="display:none;">
                    <td style=" padding-left:18px;"><input id="check_note" name="check_note" class="easyui-textbox easyui-validatebox textbox-f validatebox-text validatebox-invalid" data-options="multiline:true, prompt:'', required:true, tipPosition: 'right', missingMessage: '请输入拒绝原因'" value="" style="width: 150px; height: 100px; display: none;" textboxname="check_note"><%-- <span class="textbox textbox-invalid" style="width: 148px; height: 98px;"><textarea class="textbox-text validatebox-text textbox-prompt validatebox-invalid" autocomplete="off" placeholder="" style="margin-left: 0px; margin-right: 0px; height: 90px; width: 140px;"></textarea><input class="textbox-value" name="check_note" value="" type="hidden"></span> --%></td>
                </tr>
                <tr><td><div id="show-error-message-box" style="color: red"></div></td></tr>
            </tbody></table>
        </div></div>
        <input id="id" name="id" value="<s:property value="studentVacation.id"/>" type="hidden">
...
<script type="text/javascript">
    ...
    function saveApproval(){
        ...
        var url = "${pageContext.request.contextPath}/studentVacationAction_checkStudentVacation.action";
    ...
    $(function () {
        /* 监听状态的变化, 显示拒绝原因 */
        $(document).on('click', 'input[name="check_status"]', function(){
            if ($(this).val() == 3) {
