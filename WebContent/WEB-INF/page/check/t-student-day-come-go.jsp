...
<head>
    ...
    <link rel="stylesheet" href="teacher/css/qiandao.css">
    <!--[if lt IE 9]>
...
<header>
    <div class="xueshengjiaodao">
        <span class="dayuhao glyphicon glyphicon-menu-left "></span>
        <span>学生签到</span>
    </div>
    <div class="banji">
        <span>大班</span>
...
<nav>
    <ul class="kinerNav">
        <li class="active">到校签到</li>
        <li class="lixiaoqiantuinav">离校签退</li>
    </ul>
    <!--<ul class="kinerNav">-->
    <!--<li> -->
    <!--到校签到</span>-->
    <!--</div></li>-->
    <!--<li><div class="lixiaoqiantui">-->
    <!--<span>离校签退</span>-->
    <!--</div></li>-->
    <!--</ul>-->
</nav>
...
<script src="teacher/js/xueshengqiandao.js"></script>
