...
<head>
	...
	<link rel="stylesheet" href="teacher/css/jiaoshiqingjia.css">
	<!--[if lt IE 9]>
	...
	<link href="teacher/js/rilixuanzeqi/mobiscroll.css" rel="stylesheet" type="text/css">
	<script src="teacher/js/rilixuanzeqi/jquery.1.7.2.min.js"></script>
	<script src="teacher/js/rilixuanzeqi/mobiscroll.js" type="text/javascript"></script>
...
<div class="neirong" id="youeryuan">
	<header>
			<span class="glyphicon glyphicon-menu-left">教师请假</span>
	...
	<section>
		...
		<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
			...
			<div id="myTabContent" class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledBy="home-tab">
					...
					<!--/////////////////////////////-->
					<form id="form" method="post" action="teacherVacationAction_t_addTeacherVacation.action">
					<div class="xuanze">
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio1" value="1"> <span>病假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio2" value="2"> <span>事假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio2" value="3"> <span>婚假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio2" value="4"> <span>产假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio2" value="5"> <span>丧假</span>
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="inlineRadio2" value="6"> <span>其他假</span>
						</label>
		...
		<script src="teacher/js/jiaoshiqingjia.js"></script>
