(function ($, window, document, undefined) {
    ...
    function showStep(skipDirection) {
        ...
        var targetElement = options._element.find(step.wrapper);
    ...
    function buildWalkthrough() {
        ...
        options.steps[_index] = $.extend(true, {}, $.fn.pagewalkthrough.defaults.steps[0], step);
        ...
        if (step.popup.type !== "modal" && step.popup.type !== "nohighlight") {
            ...
            $("<div>").addClass("overlay-hole").height(Math.min(maxHeight, targetElement.outerHeight()) - 15).width(targetElement.outerWidth() + 18).css({
                padding: "20px",
                position: "absolute",
