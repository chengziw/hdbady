...
<link rel="stylesheet" type="text/css" href="teacher/css/denglu.css" />

<script type="text/javascript" src="teacher/js/jquery.min.js"></script>
<script type="text/javascript" src="teacher/js/denglu.js"></script> 

</head>
<s:if test="#session.loginTeacher.phone!=null">
	<jsp:forward page="${pageContext.request.contextPath}/teacherAction_t_home.action"></jsp:forward>
</s:if><s:else>
<body>
	...
	<div class="cd-user-modal"> 
		<div class="cd-user-modal-container">
			...
			<div id="cd-login"> <!-- 登录表单 -->
				<form class="cd-form" action="${pageContext.request.contextPath}/teacherAction_teacherLogin.action" id="fm">
					<p class="fieldset">
			...
			<!-- <div id="cd-signup"> 注册表单
				<form class="cd-form" action="index.html">
					...
					<p class="fieldset">
						<input class="full-width2" style="border: 5px;height: 50px;background-color: #219CE2" type="button" value="注册新用户">
					</p>
				</form>
			</div> -->
	...
	<script src="teacher/webdemo/im/js/register.js"></script> --%>
...
<script type="text/javascript" src="js/common.js"></script>
	<script>
		$("#denglude").click(function () {
			...
			var  url="teacherAction_teacherLogin.action";
			$('#fm').form('submit',{
		        url: url,
...
//		            alert("  用户名  "+username+"  密码   "+password);
		...
		function tiaoye(){
			location.href = "teacherAction_t_home.action";
		}
	</script>
</body>
</s:else>
